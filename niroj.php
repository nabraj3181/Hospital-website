...
<body>
  <section style="display: flex;  ;">
    <div class="fsubmit">
      <img src="image/Dr niresh shrestha.jpg" alt="image1"><br>

      <b>Dr.Niroj Nepal</b><br>
      <b>Specialization: General Physician</b><br>
      <b>NMC:4281</b><br>
      <b>Days:Sunday,Monday</b><br>
    ...
    <form class="appointment" action="appointment.php" method="post">
      ...
      <input type="text" id="name" name="doctor" value="Dr.Niroj Nepal"  readonly><br>
      ...
      <div class="radio-group">
        ...
        <label for="monday" style="font-weight: 500;">Monday</label><br>
      </div>
